...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		if ('5.0.6.1' == '@' . 'kunenaversion' . '@')
		{
			...
			{
				self::$version = strtoupper('5.0.6.1');
			}
		}
		else
		{
		...
		self::$version_date = ('2017-01-28' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2017-01-28';
		self::$version_name = ('Falanouc' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Falanouc';
	}
}
